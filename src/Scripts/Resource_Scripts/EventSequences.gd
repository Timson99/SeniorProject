...
var sequences = {
	...
	"test_seq3" : "res://Scripts/Joe_Test_Scripts/Sequence_Tests/ActorSequenceTest_01.gd",
	"test_seq4" : "res://Scripts/Joe_Test_Scripts/Sequence_Tests/ActorSequenceTest_02.gd",
