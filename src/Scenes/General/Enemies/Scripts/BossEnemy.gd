...
onready var data = EnemyManager.Enemies["Bully"]
...
func _ready():
	EnemyManager.add_enemy_data(name, self)
...
func initiate_battle():	
	EnemyManager.queued_battle_enemies.append(name)
	EnemyManager.queued_battle_ids.append(name)
